# Отчёты по проекту "Веб-приложение для записи на проекты"
...
### Итерация 1 (даты: 01.02 – 25.02)
- [Презентация](iterations/iteration-1/presentation.pdf)
- [Запланированные задачи](iterations/iteration-1/tasks_planned.md)
- [Выполненные задачи](iterations/iteration-1/tasks_completed.md)
...
Протоколы встреч с заказчиком: [customer_sync/](customer_sync/) 
